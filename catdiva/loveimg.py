...
def hug():
	try:		
		url = random.choice([kek,lol,rfr,tgt,yhy,uju,img5,img6,img7,img8,img9,img10,img11,img12,img13,img14,img15,img16,img17,img18])
	except Exception as e:
		raise errors.NothingFound(noresponse)	

def kiss():
	try:	
		url = random.choice([чмок1, чмок2, чмок3, чмок4, чмок5, чмок6, чмок7, чмок8])
	except Exception as e:
		raise errors.NothingFound(noresponse)	

def poke():
	try:	
		url=random.choice([тык1, тык2, тык3, тык4, тык5, тык6, тык7, тык8])
	except Exception as e:
		raise errors.NothingFound(noresponse)	